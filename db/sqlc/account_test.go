...
// createRandomAccount creates and verifies a random account
...
// TestGetAccount tests fetching an account by ID
...
// TestListAccounts tests listing accounts with pagination
